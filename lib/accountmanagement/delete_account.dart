            ...
            builder: (context, setState) {
              return AlertDialog(
                ...
                content: SingleChildScrollView(
                  child: ListBody(
                    children: [
                      Text('Um Ihren Account zu löschen müssen Sie '
                ...
                actions: [
                  TextButton(
                    ...
                    onPressed: () async {
                      _isPasswordValid = await
                      authService.value.validatePassword(passwordController.text);
                      setState(() {});
                      if (_isPasswordValid) {
                        authService.value.deleteAccount(email: emailController.text,
